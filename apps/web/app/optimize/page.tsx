        ...
        <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-gray-600 space-y-2">
                      {workflow.data.userProfile.experience.slice(0, 5).map((exp, idx) => (
                        <li key={idx} className="border-l-2 border-green-200 pl-3">
                          <span className="font-medium">{exp.position}</span> at {exp.company}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                {workflow.data.gapAnalysis.keywords_to_include?.length > 0 && (
                  <div>
                    <h4 className="text-sm font-semibold text-green-700 mb-2">Keywords to Include</h4>
                    <div className="flex flex-wrap gap-1">
                      {workflow.data.gapAnalysis.keywords_to_include.slice(0, 10).map((k, idx) => (
                        <span key={idx} className="px-2 py-0.5 bg-green-100 text-green-700 text-xs rounded">{k}</span>
                      ))}
                    </div>
                  </div>
                )}
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
            ...
            <button
              ...
              className="px-8 py-3 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 transition-colors inline-flex items-center"
            >

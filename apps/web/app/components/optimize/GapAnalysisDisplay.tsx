      ...
      <div className="flex items-center justify-between">
        ...
        {onRerun && (
          <button
            ...
            className="inline-flex items-center px-3 py-1.5 text-sm font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded-lg hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            title="Re-run gap analysis with updated profile information"
          >
            {isRerunning ? (
              <>
